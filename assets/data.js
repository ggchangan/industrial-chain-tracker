window.INDUSTRY_CHAIN_LIBRARY = {
  ...
  "chains": [
    ...
    },
    {
      ...
      "title": "半导体设备产业链",
      "shortTitle": "半导体设备",
      "theme": "AI算力、存储扩产、国产替代和先进封装四重共振，前道核心设备与后道封测设备同步进入订单验证期。",
      "status": "已建档",
      "trackingProfile": {
        "title": "半导体设备专属动态追踪",
        "summary": "重点看晶圆厂资本开支、存储扩产、前道设备订单、后道封测利润弹性，以及精密零部件、电子特气、光学与量检测等低国产化环节的突破。",
        "metrics": [
          {
            "name": "晶圆厂CAPEX",
            "why": "晶圆厂资本开支决定设备订单的总水位。",
            "signals": [
              "AI芯片扩产",
              "存储扩产",
              "先进逻辑产线",
          ...
          {
            "name": "前道核心设备",
            "why": "刻蚀、薄膜沉积、清洗、CMP和量检测是国产替代主战场。",
            "signals": [
              "刻蚀订单",
              "PECVD/ALD",
              "清洗设备",
          ...
          {
            "name": "后道封测设备",
            "why": "先进封装扩产带动激光划片、直写光刻、测试机等设备利润兑现。",
            "signals": [
              "先进封装",
              "激光划片",
              "直写光刻",
          ...
          {
            "name": "零部件与特气国产化",
            "why": "精密零部件、光学系统和电子特气是设备国产化深度的关键约束。",
            "signals": [
              "真空腔体",
              "高洁净管路",
              "光刻气认证",
          ...
          {
            "name": "利润兑现质量",
            "why": "前道设备研发投入高，后道设备利润弹性快，需要区分收入增长与盈利质量。",
            "signals": [
              "毛利率",
              "扣非净利",
              "经营现金流",
      ...
      "chain": [
        {
          "id": "upstream",
          "name": "上游：核心零部件及材料",
          "role": "决定设备可靠性、洁净度、精度与国产化深度",
          "segments": [
            {
              "name": "精密零部件",
              "companies": "富创精密、新莱应材",
              "logic": "真空腔体、高洁净管路、结构件和模组产品随设备扩产持续放量。"
            },
            {
              "name": "光学系统",
              "companies": "茂莱光学、福晶科技",
              "logic": "光刻和量测设备对高端光学元件依赖度高，国产替代空间大。"
            },
            {
              "name": "电子特气",
              "companies": "中船特气、华特气体",
              "logic": "光刻气和高纯电子气体认证壁垒高，国产供应链稀缺性强。"
            },
            {
              "name": "半导体材料",
              "companies": "江丰电子、沪硅产业",
              "logic": "靶材和大硅片与设备周期深度耦合，是材料端延伸观察线。"
            }
          ]
        },
        {
          "id": "midstream",
          "name": "中游：半导体设备制造",
          "role": "前道核心装备与后道封测设备共同承接晶圆厂和先进封装资本开支",
          "segments": [
            {
              "name": "刻蚀/平台型设备",
              "companies": "中微公司、北方华创",
              "logic": "刻蚀设备和平台型设备是国产替代确定性最高的主赛道。"
            },
            {
              "name": "薄膜沉积",
              "companies": "拓荆科技、微导纳米",
              "logic": "PECVD、ALD 受先进逻辑、DRAM/HBM、3D NAND 堆叠拉动。"
            },
            {
              "name": "清洗/CMP/涂胶显影/量检测",
              "companies": "盛美上海、芯源微、华海清科、中科飞测",
              "logic": "清洗和CMP国产化率较高，量检测仍是高价值低国产化环节。"
            },
            {
              "name": "后道封测设备",
              "companies": "大族激光、芯碁微装、长川科技、华峰测控",
              "logic": "先进封装扩产让激光、直写光刻和测试设备利润弹性更快释放。"
            }
          ]
        },
        {
          "id": "downstream",
          "name": "下游：晶圆制造与封装测试",
          "role": "AI芯片、存储和先进封装需求向设备端传导",
          "segments": [
            {
              "name": "晶圆代工",
              "companies": "中芯国际、华虹等",
              "logic": "先进逻辑和成熟制程共同支撑设备采购。"
            },
            {
              "name": "存储IDM",
              "companies": "DRAM、HBM、3D NAND 产线",
              "logic": "存储扩产对刻蚀、沉积、清洗和量检测设备拉动更直接。"
            },
            {
              "name": "先进封装与测试",
              "companies": "封装测试厂",
              "logic": "TSV、CoWoS、Chiplet 带来后道设备第二增长曲线。"
            }
          ]
        }
      ],
      "logic": [
        {
          "title": "四重共振",
          "body": "AI算力、存储扩产、国产替代、政策周期共同推动半导体设备需求上行。"
        },
        {
          "title": "国产替代加速",
          "body": "大基金三期和晶圆厂验证窗口打开，设备国产化从有无进入好坏阶段。"
        },
        {
          "title": "先进封装增量",
          "body": "TSV、Chiplet 和高端封测需求带动后道设备利润弹性快速释放。"
        },
        {
          "title": "低国产化环节突破",
          "body": "光学、量检测、电气仪表等环节仍是长期高价值替代空间。"
        }
      ],
      "watchlist": [
        {
      ...
      "updates": [
        ...
        },
        {
          "date": "2026-06-04",
          "segment": "设备板块",
          "signal": "将6月板块强势与存储/AI扩产作为首条动态观察线",
